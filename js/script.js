...
$(document).ready(function($) {
	...
	var fenway = [25.06798733718953,121.36517500000002]; //Change a map coordinate here!
	var markerPosition = [25.06798733718953,121.36517500000002]; //Change a map marker here!
	$('.map')
		.gmap3({
			center:fenway,
			zoom: 14,
